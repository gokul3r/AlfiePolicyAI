# Design Guidelines for Alfie - Insurance Policy Management App
...
**Hierarchy:**
- App Title "Alfie": text-4xl font-bold (brand presence)
...
- "Alfie" wordmark with subtle icon/logo element (e.g., shield or umbrella icon from Heroicons)
